...
export default defineConfig({
  ...
  redirects: {
    ...
    '/explanation/checkpoint-preview': `${basePath}build/checkpoint-a-change/`,
    '/build/review-a-completed-change': `${basePath}build/checkpoint-a-change/`,
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Checkpoint a Change',
              translations: {
                'vi-VN': 'Checkpoint một thay đổi',
                'zh-CN': 'Checkpoint 一个变更',
                'fr-FR': 'Checkpoint d’un changement',
                'cs-CZ': 'Checkpoint změny',
              },
              slug: 'build/checkpoint-a-change',
            },
            {
