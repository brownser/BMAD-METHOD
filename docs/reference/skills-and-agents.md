...
| `bmad-correct-course`           | Assess a significant mid-sprint change and produce a change proposal                              | [Design UX and Architecture](../plan/design-ux-and-architecture.md)                           |
